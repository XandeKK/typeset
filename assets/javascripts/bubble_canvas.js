class BubbleCanvas {
	...
	mouse_is_within() {
		if (this.rect.x2 < this.rect.x1 && this.rect.y2 < this.rect.y1) {
			return (this.canvas.mousePos.x >= this.rect.x1 + this.width && this.canvas.mousePos.x <= this.rect.x1 &&
			this.canvas.mousePos.y >= this.rect.y1 + this.height && this.canvas.mousePos.y <= this.rect.y1)
		}
